...
#making datasets balanced, merging them and splitting to train_data and validation_data
...
decision_tree_model.fit(train_data,train_data[target])
small_model.fit(np_train_data,np_target)
